            ...
            <View className="flex-row flex-wrap justify-between gap-y-3 mt-2">
              <View className="w-full mb-1">
                ...
                <View style={{ backgroundColor: 'rgba(122,215,198,0.06)', borderWidth: 0.5, borderColor: 'rgba(122,215,198,0.2)', borderRadius: 16, height: 50, justifyContent: 'center', paddingHorizontal: 16 }}>
                  <TextInput keyboardType="numeric" value={manualMeal.cal} onChangeText={(v) => setManualMeal(p => ({ ...p, cal: v }))} editable={!isSavingManual} style={{ color: '#7ad7c6', fontWeight: '700', fontSize: 18 }} placeholder="e.g. 450" placeholderTextColor="rgba(122,215,198,0.3)" keyboardAppearance="dark" />
                </View>
              </View>
              ...
              {['pro', 'carbs', 'fat'].map((macro, idx) => (
                <View key={idx} className="w-[31%]">
                  ...
                  <View style={{ backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)', borderRadius: 16, height: 48, justifyContent: 'center', paddingHorizontal: 14 }}>
                    <TextInput keyboardType="numeric" value={(manualMeal as any)[macro]} onChangeText={(v) => setManualMeal(p => ({ ...p, [macro]: v }))} editable={!isSavingManual} style={{ color: 'white', fontWeight: '600', fontSize: 16 }} placeholder="0" placeholderTextColor="rgba(255,255,255,0.15)" keyboardAppearance="dark" />
                  </View>
                </View>
              ))}
              ...
              <View className="w-full mt-2">
                ...
                <View style={{ backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)', borderRadius: 16, minHeight: 50, paddingVertical: 14, paddingHorizontal: 16 }}>
                  <TextInput value={manualMeal.desc} onChangeText={(v) => setManualMeal(p => ({ ...p, desc: v }))} editable={!isSavingManual} multiline style={{ color: 'white', fontSize: 15 }} placeholder="e.g. Chicken salad with olive oil..." placeholderTextColor="rgba(255,255,255,0.15)" keyboardAppearance="dark" />
                </View>
              </View>
            </View>
