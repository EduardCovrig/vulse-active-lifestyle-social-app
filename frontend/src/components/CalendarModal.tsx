    ...
    <>
      <SwipeableModal visible={visible} onClose={onClose}>
        <BlurView 
          intensity={80} 
          tint="dark" 
          style={{ height: SCREEN_HEIGHT * 0.88, borderTopLeftRadius: 28, borderTopRightRadius: 28, overflow: 'hidden' }}
        >
          ...
          <View style={{ paddingTop: 4, paddingHorizontal: 20, paddingBottom: 12 }}>
