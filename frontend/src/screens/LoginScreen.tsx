...
export default function LoginScreen({ navigation }: any) {
  ...
  const progressWidth = useRef(new Animated.Value(1 / 2)).current;
      ...
      >
        ...
        >
          ...
          <View className="mb-10 items-center mt-32">
            <Text className="text-white/60 text-base tracking-widest font-extrabold uppercase mt-1 text-center px-4">Enter your healthy era.</Text>
          </View>
              ...
              {currentStep === 0 && (
                <View className="flex-col gap-6">
                  <View className="flex-col gap-2">
                    <Text className="text-white/40 text-[10px] font-black tracking-widest uppercase ml-1">Email</Text>
                    <TextInput
                  ...
                  <View className="flex-row justify-center mt-4 gap-2">
                    <Text className="text-white/40 font-semibold text-sm">New here?</Text>
                    <TouchableOpacity onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); navigation.navigate('Register'); }}>
                      <Text className="text-[#7dd3fc] font-black text-sm">Join VULSE</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              )}
